...
const StripeCheckoutForm = ({orderData}) => {
    ...
    return (
        <div className="stripe-form-container">
            <form onSubmit={handleFormSubmit} className="px-4 py-6 m-auto border stripe-form w-308px lg:w-600px lg:px-8 lg:py-10">
                <h2 className="mb-6 text-white uppercase font-600">Stripe Payment: Pay with card</h2>
                <div className="mb-4">
                ...
                {checkoutError ? <div className="my-4 text-sm text-white">{checkoutError}</div> : null}
                <button className="px-4 py-2 font-bold text-white bg-pink-400 hover:bg-pink-300" disabled={isProcessing || !stripe}>
